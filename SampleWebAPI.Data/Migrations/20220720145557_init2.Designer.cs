...
namespace SampleWebAPI.Data.Migrations
{
    ...
    [Migration("20220720145557_init2")]
    partial class init2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SampleWebAPI.Domain.SType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SampleWebAPI.Domain.SwordElementStat", b =>
                {
                    b.Property<string>("EarliestElement")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SampleWebAPI.Domain.SType", b =>
                {
                    b.HasOne("SampleWebAPI.Domain.Sword", null)
                        .WithOne("SType")
                        .HasForeignKey("SampleWebAPI.Domain.SType", "SwordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
